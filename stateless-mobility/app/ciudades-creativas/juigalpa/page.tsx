...
export default function JuigalpaPage() {
  return (
    <main className="min-h-screen bg-white text-slate-800 font-sans pb-24">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8 pt-8 pb-4">
        <div className="text-sm font-medium text-slate-500 flex items-center gap-2">
          ...
          <span>›</span>
          <span className="text-slate-900 font-bold">Juigalpa</span>
        </div>
      </div>
      ...
      <section className="max-w-[1200px] mx-auto px-6 lg:px-8 py-12">
        <div className="rounded-3xl border border-slate-200 bg-slate-50 p-8 shadow-sm">
          ...
          <h1 className="text-4xl md:text-5xl font-black tracking-tight text-slate-900">Juigalpa</h1>
          <p className="mt-4 max-w-2xl text-lg text-slate-600">
            Juigalpa ofrece una combinación de identidad local y oportunidades para el desarrollo cultural y turístico.
          </p>
        </div>
      </section>
    </main>
