...
INSERT INTO public.departments (id, name, slug, code, description, is_creative_region, status) VALUES
  ...
  ('dept-09', 'Chinandega', 'chinandega', 'CH', 'Tierra de volcanes, agricultura fértil, gastronomía marina y tradiciones religiosas coloniales.', false, 'active'),
...
-- C. Circuitos Creativos Principales
INSERT INTO public.creative_routes (id, municipality_id, name, slug, description, theme, difficulty, estimated_duration, points_award, badge_name, badge_icon, cover_image, route_color, is_visible_in_map, status) VALUES
  ...
  ('route-02', 'mun-03', 'Circuito Creativo “Tierra Viva”', 'circuito-tierra-viva-san-juan-de-oriente', 'Recorrido que celebra la tradición alfarera y la riqueza artesanal de San Juan de Oriente como museo abierto, integrando talleres vivenciales, murales, gastronomía ancestral y miradores.', 'Artesanía & Cerámica Ancestral', 'Fácil', 150, 250, 'Maestro del Barro Vivo', 'Sparkles', 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=1600&auto=format&fit=crop', '#ea580c', true, 'published')
ON CONFLICT (slug) DO UPDATE SET
  name = EXCLUDED.name,
  description = EXCLUDED.description,
...
INSERT INTO public.route_places (id, route_id, municipality_id, name, slug, description, category, icon_name, image_url, audio_guide_url, vr_360_url, is_primary_route_point, walk_time, address, points_reward, lat, lng, order_num, status) VALUES
  ...
  ('place-sjo-01', 'route-02', 'mun-03', 'Plaza San Juan de los Platos', 'plaza-san-juan-de-los-platos', 'Punto de partida del circuito con su anfiteatro y tiendas de artesanías, donde se encuentra el mupis con el mapa guiado del recorrido.', 'Plaza & Orientación Turística', 'Landmark', 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=800&auto=format&fit=crop', NULL, NULL, true, 'Punto de inicio', 'Plaza Central de San Juan de Oriente', 50, 11.9056, -86.0758, 1, 'active'),
  ('place-sjo-02', 'route-02', 'mun-03', 'Taller Escuela del Maestro Valentín López', 'taller-escuela-valentin-lopez', 'Espacio de aprendizaje donde los visitantes conocen de cerca el proceso de transformación de la arcilla, desde su preparación hasta la creación de piezas únicas.', 'Taller Escuela & Alfarería', 'Store', 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=800&auto=format&fit=crop', NULL, NULL, true, '3 min a pie', 'Del Parque Central 1c al este, San Juan de Oriente', 60, 11.9062, -86.0751, 2, 'active'),
  ('place-sjo-03', 'route-02', 'mun-03', 'Senderos Místicos (Murales Culturales)', 'senderos-misticos-murales', 'Murales de interés cultural en calles y callejones que narran la cosmovisión, mitología y tradición alfarera comunitaria.', 'Muralismo & Arte Urbano', 'Sparkles', 'https://images.unsplash.com/photo-1544717305-2782549b5136?w=800&auto=format&fit=crop', NULL, NULL, true, '2 min a pie', 'Calles principales del casco histórico', 40, 11.9051, -86.0762, 3, 'active'),
  ('place-sjo-04', 'route-02', 'mun-03', 'Taller Urraca del Maestro Alfredo Espinoza', 'taller-urraca-alfredo-espinoza', 'Centro de producción y encuentro cultural con demostraciones en vivo y talleres vivenciales para estudiantes y visitantes.', 'Taller Vivencial & Producción', 'Store', 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=800&auto=format&fit=crop', NULL, NULL, true, '4 min a pie', 'Barrio Buena Vista, San Juan de Oriente', 50, 11.9048, -86.0748, 4, 'active'),
  ('place-sjo-05', 'route-02', 'mun-03', 'Alfarería GUERRERO', 'alfareria-guerrero-sjo', 'Taller alfarero tradicional para observar la elaboración, participar en experiencias prácticas de torno y adquirir piezas representativas.', 'Alfarería Tradicional', 'Store', 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=800&auto=format&fit=crop', NULL, NULL, true, '3 min a pie', 'Costado Norte de la Parroquia San Juan Bautista', 50, 11.9068, -86.0765, 5, 'active'),
  ('place-sjo-06', 'route-02', 'mun-03', 'Taller Ecos Precolombinos (Memorial Maestro Gregorio Bracamontes)', 'taller-ecos-precolombinos-gregorio-bracamontes', 'Espacio que honra la memoria y el legado artístico de uno de los grandes referentes de la cerámica tradicional y precolombina.', 'Memorial & Patrimonio', 'Landmark', 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=800&auto=format&fit=crop', NULL, NULL, true, '3 min a pie', 'Avenida de los Maestros Alfareros', 60, 11.9042, -86.0755, 6, 'active'),
  ('place-sjo-07', 'route-02', 'mun-03', 'Chicha Buja Doña Loña', 'chicha-buja-dona-lona', 'Rescate de la preparación artesanal de la chicha bruja de maíz fermentado, presentaciones de la danza de los Chinegros y muestra de murales.', 'Gastronomía Tradicional & Danza', 'Utensils', 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=800&auto=format&fit=crop', NULL, NULL, true, '2 min a pie', 'Calle del Calvario, San Juan de Oriente', 50, 11.9059, -86.0742, 7, 'active'),
  ('place-sjo-08', 'route-02', 'mun-03', 'Mirador De Gran Belleza Escénica “Sendero El Caballito”', 'mirador-sendero-el-caballito', 'Sendero rodeado de paisajes verdes y vistas panorámicas que permiten apreciar la riqueza ambiental de la zona, invitando a la contemplación y el descanso.', 'Mirador & Naturaleza', 'Compass', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&auto=format&fit=crop', NULL, NULL, true, '8 min a pie', 'Sector Mirador a la Laguna, San Juan de Oriente', 70, 11.9080, -86.0715, 8, 'active')
ON CONFLICT (slug) DO UPDATE SET
  name = EXCLUDED.name,
