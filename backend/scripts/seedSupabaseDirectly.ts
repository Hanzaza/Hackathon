...
async function seedSupabaseDirectly() {
  ...
  const municipalitiesData = [
    ...
    },
    {
      ...
      slug: 'catarina',
      department_id: getDeptId('Masaya'),
      subtitle: 'Jardín de Nicaragua y Ciudad Creativa del Diseño Paisajístico',
      description: 'Mirador panorámico sobre la Laguna de Apoyo, viveros florales y artesanías de bambú y madera.',
      is_creative: true,
      municipality_type: 'creativa',
